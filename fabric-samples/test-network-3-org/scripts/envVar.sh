...
export PEER0_ORG1_CA=${TEST_NETWORK_HOME}/organizations/peerOrganizations/RBI.example.com/tlsca/tlsca.RBI.example.com-cert.pem
export PEER0_ORG2_CA=${TEST_NETWORK_HOME}/organizations/peerOrganizations/HDFC.example.com/tlsca/tlsca.HDFC.example.com-cert.pem
...
export PEER0_ORG4_CA=${TEST_NETWORK_HOME}/organizations/peerOrganizations/SBI.example.com/tlsca/tlsca.SBI.example.com-cert.pem
...
setGlobals() {
  ...
  if [ $USING_ORG -eq 1 ]; then
    ...
    export CORE_PEER_MSPCONFIGPATH=${TEST_NETWORK_HOME}/organizations/peerOrganizations/RBI.example.com/users/Admin@RBI.example.com/msp
    export CORE_PEER_ADDRESS=localhost:7051
  elif [ $USING_ORG -eq 2 ]; then
    export CORE_PEER_LOCALMSPID=HDFC
    export CORE_PEER_TLS_ROOTCERT_FILE=$PEER0_ORG2_CA
    export CORE_PEER_MSPCONFIGPATH=${TEST_NETWORK_HOME}/organizations/peerOrganizations/HDFC.example.com/users/Admin@HDFC.example.com/msp
    export CORE_PEER_ADDRESS=localhost:9051
  elif [ $USING_ORG -eq 4 ]; then
    export CORE_PEER_LOCALMSPID=SBI
    export CORE_PEER_TLS_ROOTCERT_FILE=$PEER0_ORG4_CA
    export CORE_PEER_MSPCONFIGPATH=${TEST_NETWORK_HOME}/organizations/peerOrganizations/SBI.example.com/users/Admin@SBI.example.com/msp
