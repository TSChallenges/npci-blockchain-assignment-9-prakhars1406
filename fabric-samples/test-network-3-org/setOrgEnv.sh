...
PEER0_ORG1_CA=${DIR}/test-network/organizations/peerOrganizations/RBI.example.com/tlsca/tlsca.RBI.example.com-cert.pem
PEER0_ORG2_CA=${DIR}/test-network/organizations/peerOrganizations/HDFC.example.com/tlsca/tlsca.HDFC.example.com-cert.pem
PEER0_ORG3_CA=${DIR}/test-network/organizations/peerOrganizations/org3.example.com/tlsca/tlsca.org3.example.com-cert.pem
PEER0_ORG4_CA=${DIR}/test-network/organizations/peerOrganizations/SBI.example.com/tlsca/tlsca.SBI.example.com-cert.pem
...
elif [[ ${ORG,,} == "SBI" || ${ORG,,} == "magnetocorp" ]]; then

   CORE_PEER_LOCALMSPID=SBI
   CORE_PEER_MSPCONFIGPATH=${DIR}/test-network/organizations/peerOrganizations/SBI.example.com/users/Admin@SBI.example.com/msp
   CORE_PEER_ADDRESS=localhost:13051
   CORE_PEER_TLS_ROOTCERT_FILE=${DIR}/test-network/organizations/peerOrganizations/SBI.example.com/tlsca/tlsca.SBI.example.com-cert.pem
